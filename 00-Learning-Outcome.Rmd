...
1. Get familiar with data extraction, transformation and load from various database systems such that participates can be self-sufficient to get needed data in enterprise environment.
